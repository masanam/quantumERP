...
function defaultCompany()
{
	...
	if (!$login_timeout) { // FA logo
    	echo "<img src='$path_to_root/themes/quantum/images1/logo.png' alt='Quantum ERP' height='70'  onload='fixPNG(this)' border='0' />";
	} else { 
	...
	end_table(1);
	echo "<center><input class='button' type='submit' value='&nbsp;&nbsp;"._("Login -->")."&nbsp;&nbsp;' name='SubmitUser'"
