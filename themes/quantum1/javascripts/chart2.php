<?php 
 # Include FusionCharts PHP Class
  ...
  $FC = new FusionCharts("Area2D","450","250");
  ...
  $strParam="caption=Sales Comparison 2013 ; xAxisName=Bulan ;yAxisName=Jumlah (dalam Kg);decimalPrecision=0; formatNumberScale=0";
